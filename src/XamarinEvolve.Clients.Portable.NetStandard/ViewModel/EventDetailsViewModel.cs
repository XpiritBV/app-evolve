...
namespace XamarinEvolve.Clients.Portable
{
    public class EventDetailsViewModel : ViewModelBase
    {
        ...
        protected override void UpdateCommandCanExecute()
        {
            ...
            loadEventDetailsCommand?.ChangeCanExecute();
        }
        ...
        Command  loadEventDetailsCommand;
        public ICommand LoadEventDetailsCommand =>
            loadEventDetailsCommand ?? (loadEventDetailsCommand = new Command(() => ExecuteLoadEventDetailsCommandAsync().IgnoreResult(ShowError), () => !IsBusy)); 
        ...
        public ICommand ReminderCommand =>
            reminderCommand ?? (reminderCommand = new Command(() => ExecuteReminderCommandAsync().IgnoreResult(ShowError))); 
