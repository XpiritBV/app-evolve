...
namespace XamarinEvolve.DataStore.Mock
{
    public class MiniHacksStore : BaseStore<MiniHack>, IMiniHacksStore
    {
		...
		public override async Task<IEnumerable<MiniHack>> GetItemsAsync(bool forceRefresh = false, Dictionary<string, string> param = null)
        {
			await InitializeStore().ConfigureAwait(false);
            return hacks as IEnumerable<MiniHack>;
        }

        public override Task<bool> InitializeStore()
        {
            if (hacks != null)
