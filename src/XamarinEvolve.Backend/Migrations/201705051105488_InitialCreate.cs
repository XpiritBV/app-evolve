    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        EndTime = c.DateTime(),
                        Level = c.String(maxLength: 3),
                        PresentationUrl = c.String(),
                        VideoUrl = c.String(),
            ...
            CreateTable(
                ...
                .PrimaryKey(t => new { t.Session_Id, t.Category_Id })
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.SessionCategories", "Category_Id", "dbo.Categories");
            DropForeignKey("dbo.SessionCategories", "Session_Id", "dbo.Sessions");
            DropIndex("dbo.SpeakerSessions", new[] { "Session_Id" });
            DropIndex("dbo.SpeakerSessions", new[] { "Speaker_Id" });
            DropIndex("dbo.SessionCategories", new[] { "Category_Id" });
            DropIndex("dbo.SessionCategories", new[] { "Session_Id" });
            DropIndex("dbo.Notifications", new[] { "CreatedAt" });
            DropIndex("dbo.MobileToWebSyncs", new[] { "CreatedAt" });
            DropIndex("dbo.MiniHacks", new[] { "CreatedAt" });
