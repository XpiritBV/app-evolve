...
namespace XamarinEvolve.DataObjects
{
    public class Sponsor : BaseDataObject
    {
        ...
        /// <summary>
        /// Gets or sets the floor where the sponsor can be found.
        /// </summary>
        /// <value>The floor level.</value>
        public int? FloorLevel { get; set; }

        /// <summary>
        /// Gets or sets the X coordinate on the floor map where the sponsor can be found.
        /// </summary>
        /// <value>The X coordinate on the floor map.</value>
        public int? XCoordinate { get; set; }

        /// <summary>
        /// Gets or sets the Y coordinate on the floor map where the sponsor can be found.
        /// </summary>
        /// <value>The Y coordinate on the floor map.</value>
        public int? YCoordinate { get; set; }

#if MOBILE
		[Newtonsoft.Json.JsonIgnore]
		public string TwitterHandle => TwitterUrl.CleanUpTwitter();
