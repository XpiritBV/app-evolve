...
namespace XamarinEvolve.Clients.UI
{
    public partial class SessionDetailsPage : BasePage
	{
        ...
        protected override async void OnAppearing()
        {
            ...
            MessagingService.Current.Subscribe<Room>(MessageKeys.NavigateToRoom, async (m, room) =>
			{
				MessagingService.Current.Unsubscribe<Room>(MessageKeys.NavigateToRoom);
				//await Navigation.PushAsync(new FloorMapPage(room), false);
				await Navigation.PushAsync(new RoomDetailsPage(room), false);
			});
        ...
        protected override void OnBindingContextChanged()
        {
			...
			var adjust = Device.RuntimePlatform != Device.Android ? 1 : -ViewModel.SessionMaterialItems.Count + 2;
