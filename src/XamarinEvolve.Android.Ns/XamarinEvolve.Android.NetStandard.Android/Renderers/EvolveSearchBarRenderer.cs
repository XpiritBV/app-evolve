...
namespace XamarinEvolve.Droid
{
    ...
    {
		public EvolveSearchBarRenderer() : base(MainApplication.ActivityContext)
		{ }
        ...
        void UpdateSearchPlate ()
        {
            ...
            var image = FindViewById<global::Android.Views.View>(searchId);
            if (image == null)
                return;

            image.SetBackgroundColor(global::Android.Graphics.Color.Transparent);
        }
