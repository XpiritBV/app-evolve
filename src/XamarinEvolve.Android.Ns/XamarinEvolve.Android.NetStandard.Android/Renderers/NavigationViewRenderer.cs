...
namespace XamarinEvolve.Droid
{
	public class NavigationViewRenderer : ViewRenderer<XamarinEvolve.Clients.UI.NavigationView, NavigationView>
	{
		...
		public NavigationViewRenderer() : base(MainApplication.ActivityContext)
		{}
		...
		public override void OnViewAdded(global::Android.Views.View child)
		{
			...
			navView.Menu.FindItem(Resource.Id.nav_feed).SetTitle($"Personal {EventInfo.EventName} page");
			...
			navView.Menu.FindItem(Resource.Id.nav_scavenger_hunts).SetVisible(FeatureFlags.ScavengerHuntsEnabled);
        ...
        protected override void OnElementChanged(ElementChangedEventArgs<XamarinEvolve.Clients.UI.NavigationView> e)
        {
            ...
            var view = Inflate(MainApplication.ActivityContext, Resource.Layout.nav_view, null);
        ...
        void UpdateImage()
        {
			profileImage.SetImageURI( Uri.Parse( Settings.Current.UserAvatar));
		}
        ...
        void NavView_NavigationItemSelected (object sender, NavigationView.NavigationItemSelectedEventArgs e)
        {
            ...
            switch (e.MenuItem.ItemId)
            {
                ...
                case Resource.Id.nav_evals:
                    ...
                    break;
				case Resource.Id.nav_scavenger_hunts:
					id = (int)AppPage.ScavengerHunts;
					break;
            }
