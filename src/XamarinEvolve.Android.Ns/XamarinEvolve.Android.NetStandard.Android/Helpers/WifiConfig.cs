...
namespace XamarinEvolve.Droid
{
    ...
    {
        private IDependencyService Locator { get; }

        public WiFiConfig() : this (new DependencyServiceWrapper())
        {
            
        }

        public WiFiConfig (IDependencyService locator)
        {
        ...
        public bool ConfigureWiFi(string ssid, string password)
        {
            try
            {
                ...
                var wifiManager = MainApplication.ActivityContext.GetSystemService(Context.WifiService) as WifiManager;
                ...
                if(netId != -1)
                {
					var result = wifiManager.EnableNetwork(netId, false);
